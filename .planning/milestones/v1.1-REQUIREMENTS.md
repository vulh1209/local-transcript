...
- [ ] **TRANS-01**: User can enable/disable translate mode trong Settings
- [ ] **TRANS-02**: Khi translate mode bat, noi tieng Viet -> output text English
- [ ] **TRANS-03**: Translation chay offline (Apple Translation framework)
- [ ] **TRANS-04**: Whisper native .translate task lam primary path

### Auto-Segment

- [ ] **SEG-01**: Toggle mode tu insert text khi detect silence (2s default)
- [ ] **SEG-02**: User co the configure silence threshold trong Settings (1-5s)
- [ ] **SEG-03**: Visual feedback khi segment duoc detect (truoc khi insert)
- [ ] **SEG-04**: SileroVAD neural detection cho accuracy cao hon energy threshold
- [ ] **SEG-05**: Buffer audio tiep tuc khi dang transcribe segment truoc
- [ ] **SEG-06**: Queue management cho multiple pending segments
- [ ] **SEG-07**: Visual indicator hien "processing X segments"
...
| SEG-01 | Phase 6 | Pending |
| SEG-02 | Phase 6 | Pending |
| SEG-03 | Phase 6 | Pending |
| SEG-04 | Phase 6 | Pending |
| SEG-05 | Phase 6 | Pending |
| SEG-06 | Phase 6 | Pending |
| SEG-07 | Phase 6 | Pending |
